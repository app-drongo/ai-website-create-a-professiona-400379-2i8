...
export default function Cta1() {
  const stats = [
    ...
    { value: "24/7", label: "Strategic Support", icon: Target }
  ]
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                ...
                Our proven methodologies deliver measurable results that drive sustainable success.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Free strategic evaluation of your current business position
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <h3 className="font-semibold">Proven Methodologies</h3>
              <p className="text-sm text-muted-foreground">
                Industry-leading frameworks with guaranteed ROI
              </p>
            </div>
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Custom strategies designed for your unique challenges
              </p>
            </div>
          </div>
        </div>
