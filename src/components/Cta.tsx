...
export default function Cta() {
  const stats = [
    ...
    { value: "2.5x", label: "Avg ROI Increase", icon: TrendingUp },
          ...
          <CardContent className="relative p-12 lg:p-16">
            <div className="text-center max-w-4xl mx-auto">
              ...
              <p className="text-lg sm:text-xl text-muted-foreground max-w-2xl mx-auto mb-12 leading-relaxed">
                Join hundreds of successful enterprises who have transformed their operations with Apex Strategic Solutions. 
                Let's discuss your strategic objectives and chart a path to sustainable growth.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              ...
              <p className="text-sm text-muted-foreground">
                Free strategic assessment with no obligation
              </p>
            </div>
